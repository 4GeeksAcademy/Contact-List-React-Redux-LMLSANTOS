		...
		if(fullName ===""){
			...
			fetch ('https://assets.breatheco.de/apis/fake/contact/', {
				...
				.then(data => {
					...
					setPhone("");
					setAddress("");
					alert(`Contact ${fullName} Successfully Added!`)
				})
				.catch(error => {
					//error handling
					console.log(error);
	...
	return (
		<div className="container">
			<div className="row g-3 mt-5">
				<h2 className="mt-4 text-center fw-bold">Add a new contact:</h2>
			...
			<div className="row mt-2">
				<div className="mx-auto col-11">
					<button onClick={onSubmit} className="col-12 btn btn-primary fw-bold">Submit</button>
				</div>
